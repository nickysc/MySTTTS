...
import com.baidu.speech.myapplication.ST.STCommonActivity;
...
public class STActivity extends STCommonActivity implements IStatus{
    ...
    private Map<String,Object> getParams(){
        ...
        // params.put(SpeechConstant.NLU, "enable");
         //params.put(SpeechConstant.VAD_ENDPOINT_TIMEOUT, 1000); // 静音时长设置，作用是静音断句的时长设置，值建议800ms-3000ms可以调节此参数，0时表示长语音，长语音不能与VAD=touch联用
        // params.put(SpeechConstant.IN_FILE, "res:///com/baidu/android/voicedemo/16k_test.pcm");
         //params.put(SpeechConstant.VAD, SpeechConstant.VAD_DNN);//dnn：开启VAD，根据静音时长切分句子/touch：关闭VAD，60s内音频，SDK等待调用stop事件结束录音
